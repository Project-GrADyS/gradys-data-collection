...
for use_phantom_agents in [True, False]:
    for critic_use_active_agents in [True, False]:
        experiments.append([
            ...
            f"--use-phantom-agents" if use_phantom_agents else f"--no-use-phantom-agents",
            f"--critic-use-active-agents" if critic_use_active_agents else f"--no-critic-use-active-agents",
