...
class Args:
    ...
    env_id: str = "CollectionEnvironment"
        ...
        for step in range(0, args.num_steps):
            ...
            for info in infos:
                if 'avg_reward' in info:
                    ...
                    print(
                        f"global_step={global_step}, avg_reward={info['avg_reward']}, episode_duration={info['episode_duration']}"
                    )
                    writer.add_scalar(
                        f"charts/avg_reward",
                        info["avg_reward"],
