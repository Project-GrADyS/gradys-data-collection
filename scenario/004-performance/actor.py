...
from arguments import ActorArgs, EnvironmentArgs, CoordinationArgs, LoggingArgs, ModelArgs
...
def execute_actor(*args):
    def execute_actor_real(current_step: torch.multiprocessing.Value,
        ...
        while action_step < 10_000:
            ...
            if action_step % actor_args.experience_buffer_size == 0:
    ...
    execute_actor_real = profiler(execute_actor_real)

    execute_actor_real(*args)

    profiler.dump_stats("actor.prof")