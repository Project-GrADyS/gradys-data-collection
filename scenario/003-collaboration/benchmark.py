...
experiments = [
    ...
    ["python", "main.py", "--num-drones=2", "--num-sensors=2", "--run-name=policy-frequency", "--exp-name=2", "--policy-frequency=3",  "--state_num_closest_sensors=2", "--state-num-closest-drones=1", "--min-sensor-priority=1", "--centralized_critic", "--total-timesteps=10000000"],
